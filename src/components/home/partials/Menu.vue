    ...
    <header data-sticky-class="not-dark" class="transparent-header full-header" id="header">
      <div id="header-wrap">
        <div class="container clearfix">
          ...
          <!-- Logo ============================================= -->
          <div id="logo">
            <a data-dark-logo="/assets/img/ids_logo85px_w.png" class="standard-logo" href="/"
              ><img alt="Infinity Dance Studio Logo" src="/assets/img/ids_logo85px.png" />
            </a>
            <a data-dark-logo="/assets/img/ids_logo85px_w.png" class="retina-logo" href="/"
              ><img alt="Infinity Dance Studio Logo" src="/assets/img/ids_logo85px.png" />
            </a>
          </div>
          <!-- #logo end -->
...
export default {
  ...
  mounted() {
    ...
    ;(function($) {
      ...
      SEMICOLON.header = {
        ...
        removeStickyness: function() {
          ...
          if (
            ($body.hasClass('device-xs') || $body.hasClass('device-xxs') || $body.hasClass('device-sm')) &&
    ...
    tpj(document).ready(function() {
      var apiRevoSlider = tpj('.tp-banner')
        .show()
        .revolution({
          dottedOverlay: 'none',
          delay: 9000,
      ...
      apiRevoSlider.bind('revolution.slide.onchange', function(e, data) {
        if (tpj(window).width() > 992) {
          if (
            ...
            tpj('#header.transparent-header.sticky-header,#header.transparent-header.semi-transparent.sticky-header').removeClass('dark')
            ...
            if (tpj('body').hasClass('dark')) {
              ...
              tpj('#header.transparent-header:not(.sticky-header,.semi-transparent)')
                .find('#header-wrap')
                .addClass('not-dark')
            } else {
              tpj('#header.transparent-header:not(.semi-transparent)').removeClass('dark')
